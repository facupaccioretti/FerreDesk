...
## Consecuencias
- **Positivas:** Reducción drástica en costos de alojamiento en Railway al compartir recursos. Aislamiento físico a nivel de consultas SQL (mitigando riesgos de fuga). Facilidad para generar copias de seguridad por cliente de forma nativa.
