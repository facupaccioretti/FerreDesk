      ...
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-2 bg-slate-600/50 rounded-2xl p-2 shadow-lg border border-slate-500/40">
          ...
          <a
            ...
            className="p-3 rounded-xl hover:bg-orange-500/20 transition-all duration-300 relative group shadow-sm hover:shadow-md transform hover:scale-105 cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
