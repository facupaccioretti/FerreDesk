...
const PlantillaFacturaA = ({ data, ferreteriaConfig, onClose }) => {
  return (
    <div className="fixed inset-0 bg-slate-900/60 flex items-center justify-center p-4 z-50">
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-lg border border-slate-200 relative overflow-hidden max-h-[95vh] flex flex-col">
        {/* Header */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">
                {data.comprobante?.tipo || "FACTURA"} {data.comprobante?.letra || "A"}
              </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
             ...
             <div className="bg-white rounded-lg border border-slate-200 p-4">
               ...
               <div className="space-y-1">
                 ...
                 <div className="text-xs text-slate-600">Tipo: {(data.comprobante?.tipo || "FACTURA").replace(/_/g, " ")}</div>
               </div>
             </div>
