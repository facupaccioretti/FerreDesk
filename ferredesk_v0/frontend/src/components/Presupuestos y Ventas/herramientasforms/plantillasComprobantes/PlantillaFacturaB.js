...
const PlantillaFacturaB = ({ data, ferreteriaConfig, onClose }) => {
              ...
              <div className="bg-slate-800 px-6 py-4 flex items-center justify-between flex-shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                       ...
                       {mapearTipoComprobante(data.comprobante)} {data.comprobante?.letra || "B"}
                     </h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className={`${tema.tarjetaClara} rounded-lg border border-slate-200 p-4`}>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-slate-600">CUIT/DNI: {data.cuit || "-"}</div>
                  ...
                  <div className={`${tema.tarjetaClara} rounded-lg border border-slate-200 p-4`}>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-slate-600">Cód. AFIP: {data.comprobante?.codigo_afip || "06"}</div>
                ...
                <div className={`${tema.tarjetaClara} rounded-lg border border-slate-200 p-3 mb-4`}>
                  <div className="grid grid-cols-3 gap-3">
                    <div className="text-center">
                      ...
                      <div className="text-xs font-bold text-slate-900">${formatearMoneda(data.ven_impneto || 0)}</div>
                    </div>
                    <div className="text-center">
                      <div className="text-xs text-slate-600 mb-1">IVA Contenido</div>
                      <div className="text-xs font-bold text-blue-600">${formatearMoneda(data.iva_global || 0)}</div>
                    </div>
                    <div className="text-center">
