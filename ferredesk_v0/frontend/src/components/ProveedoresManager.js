                          ...
                          proveedoresPagina.map((p) => (
                            <React.Fragment key={p.id}>
                              <tr className="hover:bg-slate-50 transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-slate-600">{p.fantasia}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-slate-600">{p.domicilio}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-slate-600">{p.tel1}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-slate-600">{p.cuit}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-slate-600">{p.sigla}</td>
