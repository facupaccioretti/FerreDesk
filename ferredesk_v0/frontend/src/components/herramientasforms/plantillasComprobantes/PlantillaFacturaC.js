    ...
    <div className="plantilla-comprobante">
      ...
      <div className="encabezado-comprobante grid grid-cols-3 gap-12 mb-12">
        ...
        <div className="centro text-center flex flex-col items-center justify-center">
          <div className="letra-comprobante text-4xl font-extrabold leading-none">{data.comprobante?.letra || 'C'}</div>
          <div className="codigo-comprobante text-xs font-semibold mb-1">Cód. {data.comprobante?.codigo_afip || '11'} ORIGINAL</div>
