      ...
      <div className="flex items-center gap-2">
        ...
        {estaAbierto && (
          <>
            ...
            {/* Convertir a Venta (solo para presupuestos) */}
            {esPresupuesto && (
              <button
                onClick={() => onConvertirAVenta(venta)}
            ...
            {/* Convertir a Factura (solo para presupuestos y ventas) */}
            {(esPresupuesto || esVenta) && (
              <button
                onClick={() => onConvertirAFactura(venta)}
