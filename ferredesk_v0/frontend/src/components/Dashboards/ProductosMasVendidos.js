  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-xl font-bold text-slate-800">Productos Más Vendidos</h3>
          <p className="text-slate-600 text-sm">Análisis de los productos con mayor demanda</p>
        </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-blue-50 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-slate-600">Producto #1</p>
        ...
        <div className="bg-green-50 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-slate-600">Total Vendido</p>
              <p className="text-lg font-bold text-slate-800">
