...
const opcionesMetrica = [
  ...
  { value: 'cantidad', label: 'Por Cantidad de Productos' },
  { value: 'frecuencia', label: 'Por Frecuencia de Compras' },
];

const ClientesMasVentasSimple = ({ tipoMetrica = 'total', onMetricaChange }) => {
