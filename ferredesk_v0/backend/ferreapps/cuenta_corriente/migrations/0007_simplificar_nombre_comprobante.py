...
RegistrosAutoImputacion AS (
    SELECT 
        ...
        CASE 
            ...
            ELSE CONCAT(
                CASE 
                    WHEN vct.comprobante_nombre LIKE 'Factura A%' OR vct.comprobante_nombre LIKE 'Factura B%' OR vct.comprobante_nombre LIKE 'Factura C%' OR vct.comprobante_nombre LIKE 'Factura E%' THEN 'Factura'
                    WHEN vct.comprobante_nombre LIKE 'Cotización%' THEN 'Cotización'
                    WHEN vct.comprobante_nombre LIKE 'Recibo%' THEN 'Recibo'
                    WHEN vct.comprobante_nombre LIKE 'Nota de Crédito%' THEN 'Nota de Crédito'
                    ELSE vct.comprobante_nombre
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cuenta_corriente', '0006_corregir_saldo_acumulado_factura_recibo'),
    ]
