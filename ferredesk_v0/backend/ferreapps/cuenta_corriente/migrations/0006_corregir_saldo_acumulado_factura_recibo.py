...
RegistrosAutoImputacion AS (
    SELECT 
        ...
        vct.ven_idcli,
        CASE 
            WHEN vct.comprobante_nombre = 'Factura' THEN 'FacRecibo'
            WHEN vct.comprobante_nombre = 'Cotización' THEN 'CotRecibo'
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cuenta_corriente', '0005_auto_imputaciones_factura_recibo'),
    ]
