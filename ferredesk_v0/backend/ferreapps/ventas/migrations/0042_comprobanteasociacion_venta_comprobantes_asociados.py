# Generated by Django 5.0.1 on 2025-06-23 19:10

import django.db.models.deletion
from django.db import migrations, models


# SQL para eliminar y recrear las vistas
DROP_VIEWS_SQL = """
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0041_add_final_price_and_rounding'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comprobante_destino', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='asociaciones_destino', to='ventas.venta')),
                ('comprobante_origen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='asociaciones_origen', to='ventas.venta')),
            ],
            options={
                ...
                'unique_together': {('comprobante_origen', 'comprobante_destino')},
            },
        ),
        migrations.AddField(
            model_name='venta',
            name='comprobantes_asociados',
            field=models.ManyToManyField(related_name='notas_de_credito_que_la_afectan', through='ventas.ComprobanteAsociacion', to='ventas.venta'),
        ),
