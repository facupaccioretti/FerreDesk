# Generated by Django 5.0.1 on 2025-07-04 12:00

from django.db import migrations

# SQL para eliminar y recrear las vistas con la lógica de cálculo corregida
DROP_VIEWS_SQL = """
...
SELECT
    ...
    , 2) AS subtotal_neto,
    -- ✅ CORRECCIÓN: Calcular IVA sobre el neto ya descontado (subtotal_neto)
    ROUND(
        ROUND(
            ((pb.precio_unitario_sin_iva - ROUND(pb.precio_unitario_sin_iva * pb."VDI_BONIFICA" / 100.0, 4))
            * (1 - COALESCE(pb."VEN_DESCU1",0)/100.0)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0045_alter_comprobanteasociacion_factura_afectada_and_more'),
    ]
