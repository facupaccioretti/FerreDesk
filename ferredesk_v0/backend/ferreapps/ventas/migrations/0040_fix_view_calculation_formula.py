...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0039_add_precio_final_y_refactor_vistas'),
    ]
    ...
    operations = [
        migrations.RunSQL(
            ...
            -- Paso 2: Recrear la vista de detalle con la nueva lógica de cálculo corregida.
            ...
            WITH PreciosBase AS (
                SELECT
                    ...
                    -- CORRECCIÓN: Calcular el precio base sin IVA usando división.
                    (vdi."VDI_PRECIO_UNITARIO_FINAL" / (1 + (ali."ALI_PORCE" / 100.0))) AS precio_unitario_sin_iva
