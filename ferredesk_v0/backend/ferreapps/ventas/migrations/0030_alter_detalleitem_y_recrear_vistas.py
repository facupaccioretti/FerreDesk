...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0029_alter_ventadetalleitem_vdi_idpro_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql="""
            ----------------------------------------------------------------------
            -- VISTA: VENTADETALLEITEM_CALCULADO (compatible con ítems genéricos)
            ----------------------------------------------------------------------
            ...
            SELECT
                ...
                -- Importe total por ítem (sin descuentos globales; se aplican más adelante)
                ROUND(
                    vdi."VDI_COSTO"
                ...
                -- IVA del ítem (sobre el importe total)
                ROUND(
                    vdi."VDI_COSTO"
                    * (1 + vdi."VDI_MARGEN" / 100.0)
                    * (1 - vdi."VDI_BONIFICA" / 100.0)
            ...
            ----------------------------------------------------------------------
            -- VISTA: VENTA_CALCULADO (suma neto e IVA por venta)
            ----------------------------------------------------------------------
            ...
            """,
            reverse_sql="""
            -- Reversión: borrar las vistas, Django aplicará la migración 0028 al hacer downgrade.
