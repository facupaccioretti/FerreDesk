...
# SQL para eliminar y recrear las vistas agregando ven_razon_social
DROP_VIEWS_SQL = """
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0047_agregar_datos_cliente_a_vista'),
    ]

    operations = [
        # Agregar campos al modelo Venta
        migrations.AddField(
            model_name='venta',
            name='ven_razon_social',
            field=models.CharField(blank=True, db_column='VEN_RAZON_SOCIAL', max_length=100, null=True),
        ),
        migrations.AddField(
            model_name='venta',
            name='ven_dni',
            field=models.CharField(blank=True, db_column='VEN_DNI', max_length=20, null=True),
        ),
        # Recrear vistas con los nuevos campos
