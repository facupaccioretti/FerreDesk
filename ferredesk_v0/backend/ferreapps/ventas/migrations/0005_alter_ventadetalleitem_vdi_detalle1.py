# Generated by Django 5.0.1 on 2025-08-19 05:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0004_nuevas_vistas'),
    ]

    operations = [
        # 1) Soltar vistas dependientes del campo que vamos a alterar
        migrations.RunSQL(DROP_VIEWS_SQL, reverse_sql=migrations.RunSQL.noop),

        # 2) Alterar longitud del campo base
        migrations.AlterField(
            model_name='ventadetalleitem',
            name='vdi_detalle1',
            field=models.CharField(db_column='VDI_DETALLE1', max_length=50, null=True),
        ),

        # 3) Recrear vistas con la definición actualizada
