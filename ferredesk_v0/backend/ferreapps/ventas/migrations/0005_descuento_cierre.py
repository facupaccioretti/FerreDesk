# Migración para agregar campo de descuento de cierre (monto fijo)
# Este campo permite aplicar un descuento en pesos al total final de la venta

from django.db import migrations, models

# SQL para actualizar la vista VENTA_CALCULADO con el nuevo campo
# OJO: Se usa CASCADE porque CUENTA_CORRIENTE_CLIENTE depende de esta vista
DROP_VIEW_SQL = """
...
# Recrear CUENTA_CORRIENTE_CLIENTE (que fue borrada por CASCADE)
CREATE_VIEW_CC_SQL = """
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # 2. Actualizar vistas (con CASCADE para dependencias)
