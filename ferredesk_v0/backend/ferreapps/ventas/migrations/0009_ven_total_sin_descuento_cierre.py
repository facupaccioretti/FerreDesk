# Migración para que ven_total = total_final (sin restar descuento de cierre)
# Resuelve error ARCA 10048: ImpTotal debe igualar ImpNeto + ImpIVA
...
SELECT
    ...
    ROUND(t.total_final, 2) AS ven_total,
    (
...
WITH VentaConTotal AS (
    ...
    WHERE vc.ven_estado != 'AN'
      ...
      AND vc.es_operacion_efectiva = TRUE
),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0008_vista_es_operacion_efectiva'),
    ]
