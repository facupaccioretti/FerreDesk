...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0031_add_subtotal_bruto_to_view'),
    ]
    ...
    operations = [
        migrations.RunSQL(
            ...
            --   • LEFT JOIN con STOCK para incluir ítems genéricos.
            --   • COALESCE para detalle/código/unidad cuando no hay STOCK.
            --   • Descuentos generales en cascada aplicados en importe e IVA.
            ----------------------------------------------------------------------
            ...
            ----------------------------------------------------------------------
            -- VISTA: VENTA_CALCULADO (con subtotal_bruto, neto e IVA correctos)
            ----------------------------------------------------------------------
