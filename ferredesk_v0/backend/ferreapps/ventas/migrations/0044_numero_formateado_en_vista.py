...
# SQL para eliminar y recrear las vistas manteniendo toda la lógica previa
DROP_VIEWS_SQL = """
...
# Copiado de la migración 0042, con la ÚNICA diferencia de que en la SELECT final
# de VENTA_CALCULADO se agrega la columna `numero_formateado`.
CREATE_VIEWS_SQL = """
...
SELECT
    ...
    -- NUEVA COLUMNA: número formateado (Letra PV-Número)
    (
        c."CBT_LETRA" || ' ' ||
...
class Migration(migrations.Migration):
    dependencies = [
        ('ventas', '0043_renombrar_campos_asociacion'),
    ]

    operations = [
        migrations.RunSQL(DROP_VIEWS_SQL, reverse_sql=CREATE_VIEWS_SQL),
