    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('localidad', models.ForeignKey(blank=True, db_column='VDO_IDLOC', null=True, on_delete=django.db.models.deletion.PROTECT, to='clientes.localidad')),
            ],
            options={
                'db_table': 'VENDEDORES',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zona', models.CharField(blank=True, db_column='CLI_ZONA', max_length=10, null=True)),
            ...
            options={
                'db_table': 'CLIENTES',
                'indexes': [models.Index(fields=['activo'], name='CLIENTES_CLI_ACT_aecb6d_idx'), models.Index(fields=['cuit'], name='CLIENTES_CLI_CUI_1e9e21_idx'), models.Index(fields=['razon'], name='CLIENTES_CLI_RAZ_0c3e6f_idx')],
            },
        ),
    ]
