    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo_empresa', models.ImageField(blank=True, help_text='Logo de la empresa para comprobantes', null=True, upload_to=ferreapps.productos.utils.file_paths.upload_logo_empresa)),
                ('certificado_arca', models.FileField(blank=True, help_text='Certificado ARCA (.pem) para autenticación con servicios web de AFIP', null=True, upload_to=ferreapps.productos.utils.file_paths.upload_certificado_arca)),
                ('clave_privada_arca', models.FileField(blank=True, help_text='Clave privada ARCA (.pem) para firma digital de comprobantes', null=True, upload_to=ferreapps.productos.utils.file_paths.upload_clave_privada_arca)),
