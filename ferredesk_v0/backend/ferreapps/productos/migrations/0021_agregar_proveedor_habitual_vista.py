...
# Para reversión, volvemos a la vista anterior
SQL_REVERT = """
DROP VIEW IF EXISTS VISTA_STOCK_PRODUCTO;
CREATE VIEW VISTA_STOCK_PRODUCTO AS
SELECT
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('productos', '0020_remove_ferreteria_alicuota_iva_por_defecto'),
    ]

    operations = [
        migrations.RunSQL(SQL_CREAR_VISTA_CON_PROVEEDOR, SQL_REVERT),
    ] 